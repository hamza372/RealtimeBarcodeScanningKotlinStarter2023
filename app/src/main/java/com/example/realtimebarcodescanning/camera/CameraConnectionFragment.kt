package com.example.realtimebarcodescanning.camera
...
import com.example.realtimebarcodescanning.R
import java.util.*
...
class CameraConnectionFragment @SuppressLint("ValidFragment") private constructor(
    ...
    private fun setUpCameraOutputs() {
        ...
        try {
            ...
            ErrorDialog.newInstance("getString(R.string.tfe_ic_camera_error)").show(childFragmentManager, FRAGMENT_DIALOG)
